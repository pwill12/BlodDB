...
const _ = require('lodash') //lodash npm package used for transforming all text to lowercase
...
app.get('/post/:userid', function(req, res) {
    ...
    blogDB.findOne({ title: mypost }, function(err, post) {
        if (!err) {
            res.render("post", {
                title: post.title,
    ...
    //     const mytitle = _.lowerCase(post.title);
